...
> Примечание: параметр `ratio` влияет **только на режим Gigascreen**.  
> В режиме 3Color смешивание всегда производится таким образом, чтобы полностью устранить мерцание, вне зависимости от значения `ratio`.
